...
public enum ErrorCode {
    ...
    PRODUCT_LIST_ITEM_NOT_ENOUGH_STOCK(HttpStatus.BAD_REQUEST, "재고가 부족한 상품이 포함되어 주문이 취소되었습니다."),
    // 매장
    ...
    // 비동기 처리
    ASYNC_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "비동기 처리 중 인터럽트가 발생했습니다"),
    ;
